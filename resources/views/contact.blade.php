            ...
            <form id="contact" method="post" role="form">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label>Nama</label>
                  <input name="name" type="text" class="form-control" placeholder="Masukkan ..." required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Judul</label>
                  <input name="title" type="text" class="form-control" placeholder="Masukkan ..." required>
                </div>
                <!-- textarea -->
                <div class="form-group">
                  <label>Konten</label>
                  <textarea name="content" class="form-control" rows="3" placeholder="Masukkan ..." required></textarea>
                </div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="alert alert-success" role="alert">
          Pesan berhasil terkirim. Klik <a href="/" class="alert-link">form kontak</a> untuk kembali.
      </div>
